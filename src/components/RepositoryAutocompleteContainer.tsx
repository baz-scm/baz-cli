...
import { useRepositories, Repository } from '../hooks/useRepositories.js';

interface RepositoryAutocompleteContainerProps {
    onSelect: (repo: Repository) => void;
}

const RepositoryAutocompleteContainer: React.FC<RepositoryAutocompleteContainerProps> = ({ onSelect }) => {
